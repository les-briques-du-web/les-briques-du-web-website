 ...
 */
 ...
 eleventyConfig.addShortcode('socialIcons', function (data) {
   ...
   switch (data.icon) {
      case 'github': return `
        <a class="social" href="${data.link}"><svg id="github" viewBox="0 0 496 512">
      ...
      case 'twitter': return `
        <a class="social" href="${data.link}"><svg id="twitter" viewBox="0 0 512 512">
      ...
      case 'linkedin': return `
        <a class="social" href="${data.link}"><svg id="linkedin" viewBox="0 0 448 512">
